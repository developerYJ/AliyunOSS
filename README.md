...
```bash
composer require developerYJ/aliyun-oss:~2.0
```
...
新建 `app/services/OSS.php`，内容可参考：[OSS.php](https://github.com/developerYJ/AliyunOSS/blob/master/example/OSS.php)，然后修改配置：
...
// 更多 options 见：https://github.com/developerYJ/AliyunOSS/blob/master/src/oss/src/Aliyun/OSS/OSSClient.php#L142-L148
...
更多用法等待着你去[发现](https://github.com/developerYJ/AliyunOSS/blob/master/example/OSS.php)。
